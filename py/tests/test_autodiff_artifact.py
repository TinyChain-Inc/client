...
def _program(metadata: DerivativeMetadata | None = None) -> DerivativeProgram:
...
def test_manifest_accepts_absent_optional_source_metadata() -> None:
    manifest = _manifest(source_library=None, source_route=None, source_operator=None, digest=None)
